...
tf.app.flags.DEFINE_float('initial_learning_rate', 0.0003,"""Initial learning rate.""")
...
def train(dataset_frame1, dataset_frame2, dataset_frame3):
  ...
  with tf.Graph().as_default():
    ...
    summaries.append(tf.summary.image('Input_Image', input_placeholder, 3))
    summaries.append(tf.summary.image('Output_Image', prediction, 3))
    summaries.append(tf.summary.image('Target_Image', target_placeholder, 3))
